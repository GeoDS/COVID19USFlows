...
parser.add_argument('--month_v3', type=str, help='Day')
parser.add_argument('--day_v3', type=str, help='Day')
parser.add_argument('--hour_v3', type=str, help='Day')
...
month_v3 = args.month_v3
day_v3 = args.day_v3
hour_v3 = args.hour_v3
...
# Num_devices
num_devices = pd.read_csv(f'2020/{month_v3}/{day_v3}/{hour_v3}/home_panel_summary.csv')
